...
trot <user.word>: user.insert_formatted(word, "TRAILING_PADDING,ALL_LOWERCASE")
moat <user.word>: user.insert_formatted(word, "TRAILING_PADDING,CAPITALIZE_FIRST_WORD")
